...
plt.subplot(2, 2, 2)
plt.bar(range(len(neg_log_data)), neg_log_data, color='orange')
plt.title('Transformed Data (Negative Log)')
plt.xlabel('Index of Attributes')
plt.ylabel('Transformed Scores')

plt.subplot(2, 2, 3)
plt.bar(range(len(exp_data)), exp_data, color='green')
plt.title('Transformed Data (Exponential)')
plt.xlabel('Index of Attributes')
plt.ylabel('Transformed Scores')

plt.subplot(2, 2, 4)
plt.bar(range(len(power_data)), power_data, color='red')
plt.title('Transformed Data (Squared)')
plt.xlabel('Index of Attributes')
plt.ylabel('Transformed Scores')

plt.tight_layout()
plt.savefig(os.path.join(output_dir, "transformed_plots.png"))
plt.show()