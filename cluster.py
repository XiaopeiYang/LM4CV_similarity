        ...
        if cfg['cluster_feature_method'] == 'linear':
            ...
            if cfg['mahalanobis']:
                ...
                if cfg.get("cosine", False):
                    best_model, best_acc = train_model(cfg, cfg['linear_epochs'], model, base_train_loader, base_test_loader, regularizer='cosine', configs=configs)

                else:
                    best_model, best_acc = train_model(cfg, cfg['linear_epochs'], model, base_train_loader, base_test_loader, regularizer=None, configs=configs)
